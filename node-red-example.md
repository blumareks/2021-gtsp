...
![node red flow and serverless hello world example](flow-function.png)
...
![api key inside the Openwhisk node set](function-node-red.png)

And then you can wire it to the Cloudant DB:

![result in the db](cloudant-insert.png)

## copy and import the code into NODE-RED:
